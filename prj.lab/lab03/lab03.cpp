...
int main()
{
	...
	Mat img = imread("../../../testdata/12345BW.jpg", CV_8UC1);
	...
	imwrite("../../../prj.lab/lab03/lab03_image_and_hist.jpg", image_orig);
	...
	imwrite("../../../prj.lab/lab03/lab03_image_func.jpg", image_func);
	...
	imwrite("../../../prj.lab/lab03/lab03_image_global.jpg", my_img_Otsu);
	...
	imwrite("../../../prj.lab/lab03/lab03_image_CLAHE_img1.jpg", image_CLAHE_img1);


	Mat CLAHE_img2 = img.clone();
	Ptr<CLAHE> clahe2 = createCLAHE();
	clahe2->setTilesGridSize(Size(30, 30));
	...
	imwrite("../../../prj.lab/lab03/lab03_image_CLAHE_img2.jpg", image_CLAHE_img2);
	
	//по умолчанию
	Mat CLAHE_img3 = img.clone();
	Ptr<CLAHE> clahe3 = createCLAHE();
	clahe1->setTilesGridSize(Size(32, 32));
	clahe2->setClipLimit(42);
	...
	imwrite("../../../prj.lab/lab03/lab03_image_CLAHE_img3.jpg", image_CLAHE_img3);
	...
	imwrite("../../../prj.lab/lab03/lab03_image_local.jpg", loc_bin_img);
	...
	imwrite("../../../prj.lab/lab03/lab03_median_img.jpg", median_img);
	...
	imwrite("../../../prj.lab/lab03/lab03_erosion_dilatation_img.jpg", erosion_dilatation_img);

	imshow("Dilatation and erosion", dilatation_erosion_img);
	imwrite("../../../prj.lab/lab03/lab03_dilatation_erosion_img.jpg", dilatation_erosion_img);
	...
	imwrite("../../../prj.lab/lab03/lab03_alpha_median_img.jpg", alpha_median_img);
	...
	imwrite("../../../prj.lab/lab03/lab03_alpha_erosion_dilatation_img.jpg", alpha_erosion_dilatation_img);
	...
	imwrite("../../../prj.lab/lab03/lab03_alpha_dilatation_erosion_img.jpg", alpha_dilatation_erosion_img);
