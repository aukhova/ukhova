...
int main( int argc, char** argv ) {
    ...
    char images_Path[MAX_PATH] = "C:\\Users\\Master\\Desktop\\test_bad\\test\\"; //E:\\testing\\test\\"; // Путь к папке с изображениями
    ...
    for (int j = 0; j < n; j++)
    {
        String objFileName = "C:\\Users\\Master\\Desktop\\reser\\01_alb_id.tif"; //argv[1];       // "F:\\projs\\Aleksandra\\opencv\\itnotesblog_ru\\step01\\Surf\\imgs\\one_sign.png";
        ...
        {
            //std::string resultFileName = "C:\\Users\\Master\\Desktop\\results\\bad\\points\\" + images_paths[j] + ".png";
            std::string resultFileName = "C:\\Users\\Master\\Desktop\\test_bad\\bad\\" + images_paths[j] + ".png";
            cv::imwrite(resultFileName, imgMatches);
            continue;
        }
        ...
        if (Distance(sceneCorners, min))
        {
            ...
            std::string resultFileName = "C:\\Users\\Master\\Desktop\\test_bad\\good\\" + images_paths[j] + ".png";
            cv::imwrite(resultFileName, imgMatches);
        }
        else
        {
    ...
    //проверка
    char images_Path_good[MAX_PATH] = "C:\\Users\\Master\\Desktop\\test_bad\\good\\"; // Путь к папке с изображениями
    char images_Path_bad[MAX_PATH] = "C:\\Users\\Master\\Desktop\\test_bad\\bad\\"; // Путь к папке с изображениями
